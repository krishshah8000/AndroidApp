...
public class SignUpActivityPat extends AppCompatActivity {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            ...
            submitButton.setOnClickListener(view -> {
                ...
                if (rgGender.getCheckedRadioButtonId() == -1) {
                    Toast.makeText(SignUpActivityPat.this, "Please select a Gender", Toast.LENGTH_SHORT).show();
                    return;
                    ...
                    FirebaseAuth.getInstance().createUserWithEmailAndPassword(email, password)
                            .addOnCompleteListener(task -> {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(SignUpActivityPat.this, "Registration Failed: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            });
    ...
    private void loadStates() {
        databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(SignUpActivityPat.this, android.R.layout.simple_dropdown_item_1line, stateList);
                stateDropdown.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(SignUpActivityPat.this, "Failed to load states", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void loadCities(String state) {
        databaseReference1.child(state).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(SignUpActivityPat.this, android.R.layout.simple_dropdown_item_1line, cityList);
                cityDropdown.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(SignUpActivityPat.this, "Failed to load cities", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveSpecialistData() {
        ...
        specialistData.put("role","Patient");
        databaseReference.child(entryId).setValue(specialistData).addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                Toast.makeText(SignUpActivityPat.this, "Registration Successful! Please Login.", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(SignUpActivityPat.this, LoginActivity.class));
                finish();
            } else {
                Toast.makeText(SignUpActivityPat.this, "Database Error!", Toast.LENGTH_SHORT).show();
            }
        });
    }
